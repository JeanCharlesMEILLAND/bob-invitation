      ...
      <div
        ...
        <div className="w-10/12">
          <HighlightedText
              ...
              text={data.titre}/>
          <div
              className="border-l-2 lg:border-l-0 border-white flex flex-col gap-10 lg:grid lg:grid-cols-4 lg:gap-10 lg:auto-rows-fr mt-10">
            {data.avantages.map((avantage, index: number) => (
                <div key={index}
                  ...
                  <div
                      className="lg:hidden w-4 h-4 min-w-[1rem] min-h-[1rem] bg-white rounded-full self-start flex-shrink-0"></div>
                  <div>
                  ...
                  <div className="hidden lg:block w-5 h-5 bg-white rounded-full mt-4 self-start"></div>
                </div>
            ))}
          </div>
          <div className="hidden lg:block -mt-[10px] w-full h-0.5 bg-white"></div>
        </div>
