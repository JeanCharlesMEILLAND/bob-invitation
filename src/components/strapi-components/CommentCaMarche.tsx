...
export default function CommentCaMarche({ data }: CommentCaMarcheProps) {
    ...
    return (<>
        <div className="relative container mx-auto px-8 pt-4 lg:pt-10  flex flex-col gap-8 2xl:gap-16 text-[var(--foreground)] z-30" data-section="commentCaMarche">
...
function BobLogo() {
    ...
    return createPortal(
        <>
            <div className="flex 2xl:hidden absolute bottom-1/2 md:bottom-0 xl:bottom-0 left-16 translate-y-1/2 md:translate-y-[15%] xl:translate-y-0 2xl:relative opacity-80 xl:opacity-100 -z-40"
