...
export default function BlocQr({ QRText, QRImage }: BlocQrProps) {
    ...
    return (
        <div className="w-full max-w-lg flex flex-col md:flex-row items-center md:items-end gap-4">
            <div className="relative w-3/4 md:w-80 h-[58vh] md:h-[32rem] lg:w-[80%] lg:h-[42rem] ">
                <Image
                    src={"/images/Advantages/bob-mobile.png"}
                    alt="Borrow and Back"
                    fill
            ...
            <div className="flex-shrink-0 flex flex-col justify-end items-center gap-4 -translate-y-2">
                ...
                <div className={`relative w-full h-24 lg:w-full lg:h-32  bg-white rounded-lg flex-shrink-0 border border-[var(--foreground)]/10 shadow`}
