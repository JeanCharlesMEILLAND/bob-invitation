"use client";
import { AdvantagesBloc } from "@/components/strapi-components/Advantages";
...
export default function CardBlur({ advantagesBloc, button }: CardBlurProps) {
    ...
    return (
        ...
        >
            <div className="pb-12 md:pb-8 lg:pb-10 w-fit h-fit backdrop-blur-3xl md:backdrop-blur-2xl rounded-[50px] border border-[var(--foreground)]/10 overflow-hidden">
                <div
...
function AdvantageList({ advantagesBloc, isBackground = false }: { advantagesBloc: AdvantagesBloc[], isBackground?: boolean }) {
    const { theme: currentTheme } = useTheme();
