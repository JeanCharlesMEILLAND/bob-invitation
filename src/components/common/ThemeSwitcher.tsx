  ...
  return (
    <div className="flex items-center gap-6 text-[var(--foreground)]">
      <button
        ...
        className={`p-1 rounded-full cursor-pointer transition-all duration-200 hover:opacity-70 ${theme === 'light' ? 'opacity-100' : 'opacity-40'
          }`}
      ...
      <button
        ...
        className={`p-1 rounded-full cursor-pointer transition-all duration-200 hover:opacity-70 ${theme === 'dark'
